          ...
          <div>
            <div className="flex flex-wrap items-start gap-4">
              <div>
                ...
                <p className="text-sm text-gray-400 mt-2">Man</p>
              </div>
            ...
            <>
              <div className="mt-8">
                ...
                <p className="text-sm text-gray-400 mt-4">
                  ...
                  delectus excepturi repellendus ipsa eaque consequatur
                  exercitationem, dignissimos sunt voluptatum enim velit
                  accusantium nulla consequuntur eligendi iusto eius quam
                  nesciunt magni.
                </p>
              </div>
        ...
        <div>
          ...
          <Slider {...settingsSlider}>
            {Array.from({ length: 5 }, (_, index) => index + 1).map(
              (number) => (
                <div data-aos="fade-up" data-aos-delay={400 + number * 100}>
                  <ProductItem />
                </div>
              )
            )}
